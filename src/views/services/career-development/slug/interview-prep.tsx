    ...
    details: [
      {
        ...
        description: 'Complete a questionnaire to share details about yourself and your desired role.',
      },
      {
        name: 'Mock-Interview Design',
        description: 'We\'ll collaborate to create a personalized mock interview tailored to your target role and industry.',
      },
      {
        name: 'First Mock Interview',
        description: 'We\'ll conduct mock interview, practice together, and provide  notes on your strengths and areas for improvement.',
      },
      {
        name: 'Feedback',
        description: 'We\'ll send you feedback for improvement, and answer your questions to prepare for your second mock interview.',
      },
      {
        name: 'Final Mock Interview',
        description: 'We\'ll help you master the interview skills, then provide final feedback and guidance to ensure you approach your next interview with confidence.',
      },
    ],
  },
];
    ...
    <>
      ...
      >
        ...
        <p className='mt-4 max-w-xl text-xl/relaxed text-center md:text-start'>
          MASTER INTERVIEWS WITH A PRO. WE'LL PROVIDE ONE-ON-ONE TRAINING TO HELP YOU EXCEL IN BEHAVIORAL INTERVIEWS AND LAND THE JOB.
        </p>
      </Jumbotron>
