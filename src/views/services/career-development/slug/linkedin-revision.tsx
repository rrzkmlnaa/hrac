    ...
    <>
      ...
      >
        ...
        <p className='mt-4 max-w-xl text-xl/relaxed text-center md:text-start'>
          IN TODAY'S JOB MARKET, NETWORKING IS CRUCIAL. EXPAND YOUR PROFESSIONAL NETWORK AND ATTRACT MORE EMPLOYERS WITH OUR EXPERT LINKEDIN STRATEGIES.
        </p>
      </Jumbotron>
