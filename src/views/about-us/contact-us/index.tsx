  ...
  return (
    <div className="w-full">
      ...
      <input
        ...
        name={name}
        id={name}
        className="block w-full rounded-md border-0 py-1.5 pl-4 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
  ...
  return (
    <section className="min-h-96">
      ...
      <div className="mx-auto max-w-screen-xl w-full grid grid-cols-2 rounded-md shadow-2xl my-10">
        ...
        <div className="flex flex-wrap justify-center items-center gap-5 rounded-r-md bg-[#004AAD] text-white">
          <NextImage 
