...
export default function Contact() {
  return (
    <section className="min-h-96">
      <div className="bg-blue-800 content-start text-white py-10">
      ...
      <div className="mx-auto max-w-screen-xl w-full grid grid-cols-2 rounded-md shadow-2xl my-10">
        ...
        <div className="flex flex-wrap justify-center items-center gap-5 rounded-r-md bg-blue-800 text-white">
          <Image 
